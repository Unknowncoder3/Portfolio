...
<p align="center">
  <strong>Recruiter-focused portfolio for Data Analytics, Business Intelligence, Machine Learning and Applied AI.</strong>
</p>

<p align="center">
  <a href="https://snehasishdasportfolio.netlify.app/">🌐 Live Portfolio</a> ·
...
>
> I build data-driven products and intelligent systems using Python, SQL, machine learning and modern AI.

**Core focus:** Python & SQL · Analytics & BI · Applied AI

👉 **[Open the live portfolio](https://snehasishdasportfolio.netlify.app/)**
...
- **Data Analytics:** Python, SQL, Pandas, NumPy, EDA and business-focused analysis
- **Business Intelligence:** Power BI, Tableau, DAX, Power Query and dashboard design
...
| **AI-Based Web Scraper** | GenAI / Retrieval | Web extraction, embeddings, FAISS and LLM-based interpretation |
| **Movie Recommendation System** | Machine Learning | TF-IDF, similarity scoring and content-based recommendations |
| **Spam SMS Detection** | NLP / ML | Text preprocessing and classification |
| **SQL Data Analysis** | Data Analytics | SQL querying, transformations and business insights |
| **Face Recognition System** | Computer Vision | Face detection and recognition workflow |
...
**Analytics & BI**  
Pandas · NumPy · Matplotlib · Excel · Power BI · Tableau · EDA · RFM Analysis

**AI / ML**  
Scikit-learn · NLP · Computer Vision · LLMs · RAG · Embeddings · FAISS · Recommendation Systems

**Engineering**  
Flask · FastAPI · Streamlit · React · Vite · REST APIs · Git · GitHub
...
- 🌐 Portfolio: https://snehasishdasportfolio.netlify.app/
...
<p align="center">
  <strong>Built to show the work, not just the title.</strong>
</p>
